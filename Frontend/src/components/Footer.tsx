                    ...
                    <div key={index}>
                        ...
                        <ul className="mt-2 space-y-2">
                            {section.links.map((link: IFooterLink, index: number) => (
                                <li key={index}>
                                    <Link to={link.href} className="hover:text-teal-400 transition text-gray-400">
                                        {link.name}
                                    </Link>
                                </li>
                            ))}
            ...
            >
                ...
                <div className="flex items-center gap-4 mt-3">
                    <a href="#!" rel="noreferrer">
                        <DribbbleIcon className="size-5 hover:text-teal-400 text-gray-500" />
                    </a>
                    <a href="#!" rel="noreferrer">
                        <LinkedinIcon className="size-5 hover:text-teal-400 text-gray-500" />
                    </a>
                    <a href="#!" rel="noreferrer">
                        <TwitterIcon className="size-5 hover:text-teal-400 text-gray-500" />
                    </a>
                    <a href="#!" rel="noreferrer">
                        <YoutubeIcon className="size-6 hover:text-teal-400 text-gray-500" />
                    </a>
                </div>
                <p className="mt-3 text-center">&copy; {new Date().getFullYear()} <a href="#" target="_blank">markcrew</a>. All rights reserved.</p>
            </motion.div>
        </footer>
    );
}